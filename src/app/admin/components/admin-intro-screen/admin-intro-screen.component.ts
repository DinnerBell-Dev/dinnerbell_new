...
@Component({
  selector: 'app-admin-intro-screen',
  templateUrl: './admin-intro-screen.component.html',
  styleUrls: ['./admin-intro-screen.component.scss']
})
export class AdminIntroScreenComponent implements OnInit {
